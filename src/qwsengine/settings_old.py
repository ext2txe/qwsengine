...
class SettingsManager_old:
    def __init__(self):
        ...
        self.default_settings = {
            ...
            "headers_global": {},          # e.g. {"X-Api-Key": "abc123", "X-Env": "dev"}
            "headers_per_host": {},        # e.g. {"example.com": {"X-Site": "ex"}}            
        }
    ...
    def _setup_web_profile(self) -> QWebEngineProfile:
        ...
        if hasattr(self.profile, "setUrlRequestInterceptor"):
            self.profile.setUrlRequestInterceptor(self._header_interceptor)
        elif hasattr(self.profile, "setRequestInterceptor"):  # very old Qt
            self.profile.setRequestInterceptor(self._header_interceptor)        
